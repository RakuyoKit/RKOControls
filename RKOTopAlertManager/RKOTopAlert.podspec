...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "git@github.com:rakuyoMo/RKOControls.git", :tag => "#{s.version}" } # #{s.version}

  s.requires_arc = true

  s.source_files = "RKOControls/RKOTopAlertManager/RKOTopAlert/RKOTopAlert/RKOTopAlert/.{h,m}"
